...
@Component({
  ...
  template: `
    <div class="flex flex-col justify-center items-center p-5">
      ...
      <p class="text-lg text-gray-700 text-center max-w-3xl">
        ...
        Simply enter the video URL, click the "Generate QR Code" button, and your QR code will be ready to share in seconds. 
